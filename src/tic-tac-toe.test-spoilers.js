// SPOILERS ALERT SPOILERS ALERT SPOILERS ALERT SPOILERS ALERT SPOILERS ALERT SPOILERS ALERT
// SPOILERS ALERT SPOILERS ALERT SPOILERS ALERT SPOILERS ALERT SPOILERS ALERT SPOILERS ALERT
// SPOILERS ALERT SPOILERS ALERT SPOILERS ALERT SPOILERS ALERT SPOILERS ALERT SPOILERS ALERT
// SPOILERS ALERT SPOILERS ALERT SPOILERS ALERT SPOILERS ALERT SPOILERS ALERT SPOILERS ALERT
// SPOILERS ALERT SPOILERS ALERT SPOILERS ALERT SPOILERS ALERT SPOILERS ALERT SPOILERS ALERT
...
describe('Square', () => {
  ...
  it('should render mark when specified', () => {
    const square = shallow(<Square value={'O'}/>);
    
    expect(square.text()).toEqual(expect.stringContaining('O'));
  });
  
  it('should be able to render italic mark', () => {
    const square = shallow(
      <Square
        value={'O'}
        shouldEmphasize={true}/>);
    
    expect(square.html()).toEqual(expect.stringContaining('<em>'));
  });

  it('should notify itself is clicked', () => {
    const onMarkHandler = jest.fn();
    const square = shallow(<Square onMark={onMarkHandler}/>);
    square.find('button').simulate('click');
    
    expect(onMarkHandler).toHaveBeenCalled();
  });
});